class Permissions:
    ...
    DM_ANYONE = 32
    CLASS_T = MANAGE_ANNOUNCE | CAN_MODIFY_AVATAR | CAN_MODIFY_STUDENT | MANAGE_ASSIGNMENT | DM_ANYONE
    SUPERUSER = MANAGE_ANNOUNCE | CAN_MODIFY_AVATAR | CAN_MODIFY_STUDENT | CAN_VIEW_ANY_CHANNEL | MANAGE_ASSIGNMENT | DM_ANYONE
    PRINCIPAL = SUPERUSER
