(function () {
  ...
  var id;
  var permissions;
  var toAnnounceClasses = [];
  const class_selector = document.querySelector("#class-selector-select-class");
  const class_selector_form = document.querySelector("#class-selector-form");
  const announcementsdiv = document.querySelector("#announcements");
  const createBackButton = document.querySelector("#create-back");
  const createCreateButton = document.querySelector("#create-create");
  const create_ann_checks = document.querySelector("#create-ann-check");
  const create_ann_input = document.querySelector("#create-ann-input");
  ...
  function buildAnnouncementListByClass(studentclass) {
  ...
  function doAnnouncements(content) {
